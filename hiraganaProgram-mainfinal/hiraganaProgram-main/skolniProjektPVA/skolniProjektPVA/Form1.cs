    ...
    public partial class Form1 : Form
    {
        ...
        private void RunAudio(object sender, EventArgs e)
        {
            ...
            catch (Exception chyba)
            {
                ...
                string message = "Jazyk Japonština není nainstalován na tomto počítači. Ten můžete nainstalovat v Nastavení > čas & jazyk > řeč.";
                string caption = "Chybí jazyk k převodu na řeč";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            switch (randomB)
            {
                case 1:
                    ...
                    button1.Tag = Generate.Get("ok", steps).ToString();
                    button1.Text = romanji[Generate.Get("ok", steps)];
                    textBox1.Text = hira[Generate.Get("ok", steps)];
                    button2.Text = romanji[Generate.Get("v1", steps)];
                    button2.Tag = "n";
                    button3.Text = romanji[Generate.Get("v2", steps)];
                    button3.Tag = "n";
                ...
                case 2:
                    ...
                    button2.Tag = Generate.Get("ok", steps).ToString();
                    button2.Text = romanji[Generate.Get("ok", steps)];
                    textBox1.Text = hira[Generate.Get("ok", steps)];
                    button1.Text = romanji[Generate.Get("v1", steps)];
                    button1.Tag = "n";
                    button3.Text = romanji[Generate.Get("v2", steps)];
                ...
                case 3:
                    ...
                    button3.Tag = Generate.Get("ok", steps).ToString();
                    button3.Text = romanji[Generate.Get("ok", steps)];
                    textBox1.Text = hira[Generate.Get("ok", steps)];
                    button1.Text = romanji[Generate.Get("v1", steps)];
                    button1.Tag = "n";
                    button2.Text = romanji[Generate.Get("v2", steps)];
